...
export default function BlList (props) {
  ...
  const onSubmit = () => {
    if(user){
      ...
      axios.post("/shipper/selectBlList",{userNo:user?user:'',bl_no:blNumber,toDate:toDate,endDate:endDate, num:1}).then(
        res => {
  ...
  const onMore = (param) => {
    if(user){
      if((param-1) !== Number(data[0].tot_page)) {
        setNum(param);
        axios.post("/shipper/selectShpConfirmList",{userNo:user?user:'', bkg_no:moreblNumber,toDate:moreTodate,endDate:moreEndDate, num:param})
                      ...
                      <Col>
                        <Row>
                            ...
                            <Row>
                              <div style={{maxWidth:'15%',}}>
                                <FormGroup style={{paddingTop:'50%'}}>
                                  <Label/>
                                  <span style={{marginLeft:'5px', fontSize:'16px',fontWeight:'bold' }}>수신일자</span>
                                </FormGroup>
                              </div>
                              <div style={{width:'40%'}}>
                          ...
                          <Col xl="3" lg="3" sm="12" md="12">
                            <FormGroup>
                              <Label className="mb-0" style={{fontSize:'16px',fontWeight:'bold' }}>BL NUMBER</Label>
                              <Input 
                                type="text" 
                                id="bknum"
                      ...
                      <Row className="bg-light pb-2 pt-2 table table-hover">
                        <Col xl="4" lg="4" md="6" sm="12"  xs="12">
                          <Row>
                            ...
                            <Col className="text-center pt-3 border-right" xl="4" lg="4" md="4" sm="4" xs="4" style={styles.normalGird}>MBL NO</Col>
                            <Col className="text-center pt-3 border-right" xl="3" lg="3" md="3" sm="3" xs="3" style={styles.normalGird}>MRN</Col>
                            <Col className="text-center pt-3 border-right" xl="3" lg="3" md="3" sm="3" xs="3" style={styles.normalGird}>SR NO</Col>
                            
                          </Row>
                        </Col>
                        <Col xl="4" lg="4" md="6" sm="12"  xs="12">
                          <Row>
                            <Col className="text-center pt-3 border-right" xl="6" lg="6" md="6" sm="6"  xs="6" style={styles.normalGird}>SCH VESSEL NAME</Col>
                            <Col className="text-center pt-3 border-right" xl="3" lg="3" md="3" sm="3"  xs="3" style={styles.normalGird}>SCH POL</Col>
                            <Col className="text-center pt-3 border-right" xl="3" lg="3" md="3" sm="3"  xs="3" style={styles.normalGird}>SCH POD</Col>
                          </Row>
                        </Col>
                        <Col xl="4" lg="4" md="6" sm="12"  xs="12">
                          <Row>
                            <Col className="text-center pt-3 border-right" xl="4" lg="4" md="4" sm="4"  xs="4" style={styles.normalGird}>SCH ODB</Col>
                            <Col className="text-center pt-3 border-right" xl="4" lg="4" md="4" sm="4"  xs="4" style={styles.normalGird}>CARGO PACK QTY</Col>
                            <Col className="text-center pt-3 border-right" xl="4" lg="4" md="4" sm="4"  xs="4" style={styles.normalGird}>BL CNTR</Col>
                          </Row>
                        </Col>
                      </Row>
                      {
                        data.length > 0 ? (
                          <>
                              {data.map((value,index) => {
                                return(
                                  <Link key={index} to={{pathname: `/bl`, state: {user_no:value.user_no, mbl_no:value.mbl_no, issue_date:value.issue_date}}}>
                                    <Row  className="border-bottom pb-3">
                                      <Col xl="4" lg="4" md="6" sm="12"  xs="12">
                                        <Row>
                                          <Col className=" text-center pt-3" xl="2" lg="2" md="2" sm="2"  xs="2">{value.rownum}</Col>
                                          <Col className=" text-center pt-3" xl="4" lg="4" md="4" sm="4"  xs="4">{value.mbl_no}</Col>
                                          <Col className=" text-center pt-3" xl="3" lg="3" md="3" sm="3"  xs="3">{value.mrn}</Col>
                                          <Col className=" text-center pt-3" xl="3" lg="3" md="3" sm="3"  xs="3">{value.sr_no}</Col>
                                        </Row>
                                      </Col>
                                      <Col xl="4" lg="4" md="6" sm="12"  xs="12">
                                        <Row>
                                          <Col className=" text-center pt-3" xl="6" lg="6" md="6" sm="6"  xs="6">{value.sch_vessel_name}</Col>
                                          <Col className=" text-center pt-3" xl="3" lg="3" md="3" sm="3"  xs="3"><span data-html="true" data-toggle="tooltip" title={value.sch_pol_name} >{value.sch_pol}</span></Col>
                                          <Col className=" text-center pt-3" xl="3" lg="3" md="3" sm="3"  xs="3"><span data-html="true" data-toggle="tooltip" title={value.sch_pod_name} >{value.sch_pod}</span></Col>
                                        </Row>
                                      </Col>
                                      <Col xl="4" lg="4" md="6" sm="12"  xs="12">
                                        <Row>
                                          <Col className=" text-center pt-3" xl="4" lg="4" md="4" sm="4" xs="4">{value.sch_odb_format}</Col>
                                          <Col className=" text-center pt-3" xl="4" lg="4" md="4" sm="4" xs="4">{value.cargo_pack_qty}</Col>
                                          <Col className=" text-center pt-3" xl="4" lg="4" md="4" sm="4" xs="4">{value.bl_cntr}</Col>
                                        </Row>
                                      </Col>
                                    </Row>
                                </Link>
