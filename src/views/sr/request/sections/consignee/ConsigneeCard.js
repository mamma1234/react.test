...
/*	  useEffect(() => {
  ...
  const toggle = (params) => {
	  ...
	  if(params==='B') {
		  ...
		  props.onLoadData("cs");
		  setPropsData({...loadData,'cons_bookmark_seq':'','consignee_bookmark_name':'','cons_code':'','cons_name1':'',
				'cons_name1':'',
				'cons_address1':'',
				'cons_address2':'',
				'cons_address3':'',
  ...
  const [clsNm, setClsNm] = useState("");
	...
	const onInitData = () => {
		...
		consigneeData ={...propsData,'cons_bookmark_seq':'','consignee_bookmark_name':'','cons_code':'','cons_name1':'',
				'cons_name1':'',
				'cons_address1':'',
				'cons_address2':'',
				'cons_address3':'',
